...
const VideoPlayer = ({ id }: Props) => {
    const { video } = useSelector((state: RootState) => state.videoPlayer.videoPlayer)
    const { details: channelDetails } = useSelector((state: RootState) => state.videoPlayer.channelDetails)
